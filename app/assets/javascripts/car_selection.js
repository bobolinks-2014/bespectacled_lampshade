...
$('#user').submit(function(e){
  ...
  request.done(function(data){
    ...
    $('.cards').prepend('<div class="large-3 columns "><ul class="pricing-table"><li class="title">'+data.name+'</li><li><img  src="http://media.caranddriver.com/images/media/51/dissected-lotus-based-infiniti-emerg-e-sports-car-concept-top-image-photo-451994-s-original.jpg" height="65" width="136" /></li><li class="description">'+data.city_mpg +'MPG City /'+data.hwy_mpg+'MPG Hwy</li><li class="bullet-item">$'+data.monthly_cost+'mo</li><li class="bullet-item">$'+data.monthly_cost+'yr</li><li class="cta-button"><a href="#" class="button round tiny">X</a></li></ul></div>');
